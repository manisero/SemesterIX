...
Korzystając ze słownika DAWG, autorzy przedstawili czterokrokowy algorytm (zwany dalej algorytmem Appela-Jacobsona), który umożliwia wyznaczenie wszystkich możliwych ruchów przy danym stanie planszy i~dostępnych do wykorzystania literach:
