...
class SearchPerformerTests(unittest.TestCase):
    def test_search_method_trivially(self):
        ...
        self.assertIn(n2_in_search_result, n1_in_search_result.edges)
        self.assertIn(n3_in_search_result, n1_in_search_result.edges)
        self.assertIn(n1_in_search_result, n2_in_search_result.edges)
        self.assertIn(n4_in_search_result, n2_in_search_result.edges)
        self.assertIn(n1_in_search_result, n3_in_search_result.edges)
        self.assertIn(n4_in_search_result, n3_in_search_result.edges)
        self.assertIn(n2_in_search_result, n4_in_search_result.edges)
        self.assertIn(n3_in_search_result, n4_in_search_result.edges)
        self.assertIn(n5_in_search_result, n4_in_search_result.edges)
        self.assertIn(n4_in_search_result, n5_in_search_result.edges)