...
namespace GRM.Presentation
{
    public class ArgsParser
    {
        public OptionSet BuildOptionSet(Options options)
        {
            ...
            optionSet.Add("sort=", "Sorting strategy. Optional. Valid values: AscendingSupport (or 0; default), DescendingSupport (or 1), Lexicographical (or 2), ReverseLexicographical (or 3).", x => options.SortingStrategy = ParseEnum<SortingStrategyType>(x));
