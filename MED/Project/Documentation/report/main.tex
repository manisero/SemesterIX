...
W celu analizy wydajności programu i wyznaczenia najlepszych strategii wykonywania poszczególnych kroków algorytmu, przeprowadzono szereg badań na czterech zbiorach danych:

\begin{itemize}
 \item car\footnote{Patrz http://archive.ics.uci.edu/ml/datasets/Car+Evaluation.},
 \item mushrooms\footnote{Patrz http://archive.ics.uci.edu/ml/datasets/Mushroom.},
 \item nursery\footnote{Patrz http://archive.ics.uci.edu/ml/datasets/Nursery},
 \item molecular\footnote{Patrz http://archive.ics.uci.edu/ml/datasets/Molecular+Biology+\%28Splice-junction+Gene+Sequences\%29.}.
\end{itemize}
 ...
 \begin{center}
  \begin{tabular}{ | r || c | c | c | c | }
   \hline
   zbiór danych            & \multicolumn{2}{|c|}{\emph{nursery}} & \multicolumn{2}{|c|}{\emph{mushrooms}} \\
   \hline
...
\section{app/ - pliki binarne aplikacji wraz z przykładowym zbiorem danych i skryptem uruchamiającym aplikację.} \label{apx:bin}
\section{source/ - kod źródłowy aplikacji.} \label{apx:source}
\section{diagrams/ - diagramy klas i zależności modułów aplikacji.} \label{apx:diagrams}
