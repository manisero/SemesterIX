...
\end{itemize}
 ...
 \end{figure}
  ...
  \begin{figure}[!ht]
   ...
   \label{fig:diag:DataSetProcessing}
  \end{figure}
  ...
  \begin{figure}[!ht]
   ...
   \label{fig:diag:GRMAlgorithm}
  \end{figure}


 \subsection{Moduł GRM.Presentation}
 Moduł \verb+GRM.Presentation+ zawiera punkt wejścia programu - metodę \verb+Main+ klasy \verb+Program+. 
